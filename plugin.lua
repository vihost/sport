...
function run(msg)
	about_key = {{{text="وبسات",url="http://climaxit.net"},{text="کانال",url="https://telegram.me/climaxit"}},{{text="ارتباط با سازنده",url="https://telegram.me/mrflatBot"}},{{text="سیم نت",url="https://telegram.me/simnetBot"},{text="ادمین",url="https://telegram.me/mrflat"}}} 	
